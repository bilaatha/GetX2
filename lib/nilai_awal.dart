  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Nilai awal",style: TextStyle(color: Colors.white),),
        actions: [
            ...
            Get.bottomSheet(
                Container(
                  ...
                  child:Column(
                    ...
                    children: [
                      TextButton(onPressed: () => Get.toNamed("/editKelas"), child:const Text("Edit Kelas")),
                      TextButton(onPressed: () => Get.toNamed("/namaSiswa"), child:const Text("Nama Siswa")),
                      TextButton(onPressed: () => Get.toNamed("/namaMatpel"), child:const Text("Nama Matpel")),
                      TextButton(onPressed: () => Get.toNamed("/jnsMatpel"), child:const Text("Jns Matpel")),
                    ],
                  ),
                )
            );
            ...
            Container(
                ...
                child:Obx(() =>
                    ListView.builder(
                        ...
                        itemBuilder:(context,index) => Text(hc.AddNamaSiswa[index],style:const TextStyle(fontSize: 16))
                    )
                )
            ),
            Container(
